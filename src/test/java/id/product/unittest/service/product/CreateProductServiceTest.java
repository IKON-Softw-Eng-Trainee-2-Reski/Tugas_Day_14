...
import id.product.unittest.application.product.service.CreateProductService;
...
public class CreateProductServiceTest {
    ...
    void createProduct_WhenProductNameIsNull_ShouldThrowConstraintViolationException(){
        EasyRandom easyRandom = new EasyRandom();
        // Given
        String expectedMessage = "Product name is required";
        Product product = new Product();
        product.setDescription(easyRandom.nextObject(String.class));
        product.setStock(easyRandom.nextInt(88));
